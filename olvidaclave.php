...
<link href="administrador/css/jquery-ui-1.8.11.custom.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.4.1/jquery.min.js"></script>
<script type="text/javascript" src="administrador/js/jquery.js"></script>
<script type="text/javascript" src="administrador/js/jquery-1.3.1.min.js"> </script>
<script type="text/javascript" src="administrador/js/jquery-ui-1.8.11.custom.min.js"> </script>
...
<body>
 <table align="center" border="0"><tr><td>
            ...
            <form id="RegisterUserForm" action="enviarclave.php" method="post">
               
                    <fieldset>
                    <p>
                        <label for="buscar_usuario">Nombre</label>
                        <input id="buscar_usuario" name="buscar_usuario" type="text" class="text" value="" />
                    </p>
